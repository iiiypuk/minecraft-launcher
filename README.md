...
[Скачиваем](https://github.com/IIIypuk/minecraft-launcher/raw/master/natives/1.10.2.zip) их и распаковываем в директорию `versions\1.10.2`, которая находится в директории с клиентом Minecraft.
